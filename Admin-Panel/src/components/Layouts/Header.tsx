                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            <h2>YUMMY</h2>
                            {/* <img className="w-32 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/relearn.png" alt="logo" /> */}
                                        ...
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            <div className="ltr:pl-4 rtl:pr-4">
                                                <div className="text-base flex items-center">
                                                    <div className="max-w-[140px] whitespace-nowrap overflow-hidden text-overflow-ellipsis">{email}</div>
                                                    {/* <span className="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2 h-[15px]">Pro</span> */}
                                                </div>
                                                <button type="button" className="max-w-[140px] overflow-hidden text-overflow-ellipsis text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white">
                                                    {email}
                                                </button>
                                            </div>
                                        </div>
