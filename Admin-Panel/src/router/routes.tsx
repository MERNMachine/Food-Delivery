...
const Groups = lazy(() => import('../pages/Classes'));
const ApplicationLists = lazy(() => import('../pages/ApplicationLists'));
...
const routes = [
    ...
    {
        path: '/',
        element: <ProtectedRoute element={<Index />} path="/" />,
    },
    {
        path: '/profile',
        element: <ProtectedRoute element={<Profile />} path="/" />,
    },
    {
        path: '/students',
        element: <ProtectedRoute element={<Students teacherId={0} onCancelChange={() => {}}/>} path="/" />,
    },
    {
        path: '/teachers',
        element: <ProtectedRoute element={<Teachers />} path="/" />,
    },
    {
        path: '/subjects',
        element: <ProtectedRoute element={<Subjects />} path="/" />,
    },
    {
        path: '/classes',
        element: <ProtectedRoute element={<Groups />} path="/" />,
    },
    {
        path: '/credit',
        element: <ProtectedRoute element={<Credit />} path="/" />,
    },
    {
        path: '/application-lists',
        element: <ProtectedRoute element={<ApplicationLists />} path="/" />,
    },
    {
        path: '/menus',
        element: <ProtectedRoute element={<Menus />} path="/" />,
    },
    {
        path: '/orders',
        element: <ProtectedRoute element={<Orders />} path="/" />,
    },
    // {
    //     path: '/index',
    //     element: <Index />,
    ...
    {
        path: '/users',
        element: <ProtectedRoute element={<Users />} path="/" />,
    },
    {
        path: '/categories',
        element: <ProtectedRoute element={<Categories />} path="/" />,
    },
    {
        path: '/users/profile',
        element: <Profile />,
